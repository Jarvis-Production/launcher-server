...
const initSQL = [
    ...
    `CREATE TABLE IF NOT EXISTS telemetry (id INTEGER PRIMARY KEY AUTOINCREMENT, hwid TEXT NOT NULL, server TEXT NOT NULL, ip TEXT NOT NULL, brand TEXT NOT NULL, version TEXT NOT NULL, timestamp INTEGER NOT NULL, created_at TEXT DEFAULT (datetime('now')))`
];
